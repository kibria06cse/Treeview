...
namespace Treeview_2.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,SchoolClassId")] Student student)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.SchoolClassId = new SelectList(db.SchoolClasses, "Id", "Name", student.SchoolClassId);
            return View(student);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,SchoolClassId")] Student student)
        {
            if (ModelState.IsValid)
            {
